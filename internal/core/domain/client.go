...
// PowerState represents the power status of a client.
...
// CrippleMode determines how a crippled client misbehaves.
...
// ClientState holds the mutable internal state of an inner client.
